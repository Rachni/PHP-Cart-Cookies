...
<head>
    ...
    <!-- ELEGIR CSS DEPENDIENDO DE LA COOKIE DEL TEMA OSCURO O CLARO -->
    <?php
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                <?php if (isset($_SESSION['user'])): ?>
                                    <button type="submit" name="addProduct" value="<?php echo $name; ?>" class="add-to-cart">Añadir al carrito</button>
                                <?php else: ?>
                                    <!-- Botón para redirigir a login.php -->
                                    <button type="button" onclick="window.location.href='login.php'" class="add-to-cart">Iniciar sesión para añadir al carrito</button>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
